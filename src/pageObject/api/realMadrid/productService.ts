...
export class ProductService {
  ...
  async overrideUpdatePayloadWithCreateValues(createPayload: any, updateVarientProductPayload: any) {
  ...
  commonFields.forEach(field => {
    if (createPayload[field] !== undefined) {
      ...
      if (typeof createPayload[field] === 'object' && 
  ...
  if (createPayload.defaultLanguageTranslations && updateVarientProductPayload.defaultLanguageTranslations) {
  ...
  if (createPayload.translatedUrls && updateVarientProductPayload.translatedUrls) {
    updateVarientProductPayload.translatedUrls = [
      ...
      ...updateVarientProductPayload.translatedUrls.filter((url: any) => 
        !createPayload.translatedUrls.some((cu: any) => cu.locale === url.locale)
      )
    ];
  }
}
