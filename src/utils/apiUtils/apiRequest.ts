...
export class ApiRequest {
  ...
  static async putRequest(request: APIRequestContext,url: string, headers: Record<string, string | null | undefined>, body: object) {
    const safeHeaders = sanitizeHeaders(headers);
  ...
  static async deleteRequest(request: APIRequestContext,url: string,headers: Record<string, string | null | undefined>)
   {
    const safeHeaders = sanitizeHeaders(headers);
  ...
  static async patchRequest(request: APIRequestContext,url: string,headers: Record<string, string | null | undefined>,body?: object) {
    const safeHeaders = sanitizeHeaders(headers);
