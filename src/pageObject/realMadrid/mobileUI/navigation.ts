...
export class MobileNavigation {
  ...
  constructor(page: Page) {
    ...
    this.navShopByPlayer = page.getByTestId('navigation-bar').getByRole('button', { name: 'Shop By Player' })
    this.navAccessories = page.getByTestId('navigation-bar').getByRole('button', { name: 'Accessories' })
    this.submenuOption = this.page.getByRole('link', { name: /Mens|Fashion/i })
    this.langButton = this.page.locator('[data-testid="navigation-bar"]').getByRole('button', { name: 'EN | USD' })
